...
function CountAge({calculateAges} : Pick<TCalAges,"calculateAges">)  {
  return (
    <div className='bg-gray-800 shadow-lg shadow-gray-900 px-2 md:px-3 py-2 rounded-xl hover:bg-gray-900 w-[75%] justify-center transition-colors duration-300 mb-5'>
